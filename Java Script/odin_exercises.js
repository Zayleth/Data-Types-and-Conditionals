...
function numberChecker() {
	if(number >= 10) { // BEFORE ---> if(number === 6)
		return true;
	} else if (number < 10) { // BEFORE } else {
		return false;
	}
}
...
console.log(greeting); // Hello! My name is Carlos Stevenson and I am 18 years old.
*/
...
/*
  ...
  ===== NOTE =====
  In order to make the tests pass you will need to use these exact values. 
  The wording also needs to be an exact match. If the tests fail, check spacing, capitalization, and punctuation:
